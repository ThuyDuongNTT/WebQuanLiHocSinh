...
namespace QuanLyHocSinh.Controllers
{
    public class QuyensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaQuyen,TenQuyen,TrangThai")] Quyen quyen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaQuyen,TenQuyen,TrangThai")] Quyen quyen)
        {
            if (ModelState.IsValid)
            {
